...
// Data class per mappare la risposta JSON di Alpha Vantage
...
object AlphaVantageFetcher {
    ...
    // Funzione sospesa per ottenere il prezzo
    ...
    // 🔹 Versione simulata per sviluppo senza consumare API
    /*
    suspend fun fetchLatestClose(symbol: String, apiKey: String): FetchResult {
        return FetchResult.Success(10.10) // prezzo fittizio
    }
    */
}
